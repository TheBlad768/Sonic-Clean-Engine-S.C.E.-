...
${AS_DIR}/p2bin -p=FF -z=0,kosinskiplus,Size_of_DAC_driver_guess,after Main.p S3CE.gen Main.h
...
${AS_DIR}/convsym Main.lst S3CE.gen -input as_lst -range 0 FFFFFF -exclude -filter \"z[A-Z].+\" -a
