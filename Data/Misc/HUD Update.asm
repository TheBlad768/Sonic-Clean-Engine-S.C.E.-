...
loc_DD64:
		...
		bne.s	locret_DDBE						; if yes, branch
		lea	(v_time).w,a1
...
.objcounter:
		...
		moveq	#0,d1
		move.b	(Lag_frame_count).w,d1			; load "number of objects" counter
		bsr.w	DrawSingleDigitNumber
		locVRAM	tiles_to_bytes($6EE),d0		; set VRAM address
		moveq	#0,d1
...
HUD_DrawInitial:
		lea	(VDP_data_port).l,a6
		locVRAM	tiles_to_bytes($6DA),VDP_control_port-VDP_data_port(a6)
...
HudDb_XY:
		locVRAM	tiles_to_bytes($6DA),VDP_control_port-VDP_data_port(a6)	; set VRAM address
