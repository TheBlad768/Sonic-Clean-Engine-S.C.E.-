...
Process_Kos_Module_Queue:
		...
		bsr.s	Queue_Kos										; add current module to decompression queue
...
.Skip:
	...
	if bytesToXcnt(Kos_module_queue_end-Kos_module_queue,8)&2
		...
		move.w	d0,(a0)+
		move.l	(Kos_module_queue).w,d0
		beq.s	LoadPLC_Raw_KosM.Done							; return if the queue is now empty
		movea.l	d0,a1
		move.w	(Kos_module_destination).w,d2
		bra.s	Process_Kos_Module_Queue_Init
