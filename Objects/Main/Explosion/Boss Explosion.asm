...
; init
ObjDat_BossExplosion1:	subObjData Map_BossExplosion, $500, 0, TRUE, 24, 24, 0, 0, collision_type.npc.none, 0, 0
ObjDat_BossExplosion2:	subObjData Map_BossExplosion, $4D2, 0, TRUE, 24, 24, 0, 0, collision_type.npc.none, 0, 0
