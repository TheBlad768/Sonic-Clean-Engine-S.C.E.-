...
namespace S3KObjectDefinitions.Common
{
	...
	class InvisibleBlock : ObjectDefinition
	{
		...
		{
			var artfile = ObjectHelper.OpenArtFile("Common/RingHUDText.kospm", CompressionType.KosinskiPlusM);
			var sprite = ObjectHelper.MapASMToBmp(artfile, "../../Objects/Main/Invisible Blocks/Object Data/Map - Invisible Block.asm", 0, 0);
